...
module.exports = ({production = false, ssr = false, lite = false} = {}) => {
  ...
  const firebaseConfig = JSON.stringify({
    apiKey: "sfdg", //process.env.FIREBASE_API_KEY,
    messagingSenderId: "sfdg", //process.env.FIREBASE_MESSAGING_SENDER_ID,
    databaseURL: "sfdg", //process.env.FIREBASE_DATABASE_URL
  });
